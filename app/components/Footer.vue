      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
        ...
        <div class="lg:col-span-2">
          ...
          <ul class="flex flex-col gap-3">
            <li v-for="link in visaLinks" :key="link.path">
              <NuxtLink :to="link.path" class="text-sm text-gray-400 hover:text-[#f59e0b] hover:translate-x-1 inline-block transition-transform">
                {{ link.name }}
              </NuxtLink>
            </li>
          </ul>
        ...
        <div class="lg:col-span-2">
          ...
          <ul class="flex flex-col gap-3">
            <li v-for="link in corporateLinks" :key="link.path">
              <NuxtLink :to="link.path" class="text-sm text-gray-400 hover:text-white transition-colors">
                {{ link.name }}
              </NuxtLink>
            </li>
          </ul>
        ...
        <div class="lg:col-span-4">
          ...
          <div class="flex flex-col gap-4 mb-8">
            <a href="tel:+9008501234567" class="flex items-start gap-3 text-sm text-gray-400 hover:text-white transition-colors group">
              <div class="mt-0.5 text-[#f59e0b] group-hover:scale-110 transition-transform">
            ...
            <a href="mailto:info@champvize.com.tr" class="flex items-start gap-3 text-sm text-gray-400 hover:text-white transition-colors group">
              <div class="mt-0.5 text-[#f59e0b] group-hover:scale-110 transition-transform">
