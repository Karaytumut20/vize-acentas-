    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
      <div class="flex items-center justify-between">
        ...
        <div class="hidden lg:flex items-center gap-4 relative z-20">
          ...
          <NuxtLink to="/iletisim" class="bg-[#f59e0b] hover:bg-[#d97706] text-white px-6 py-2.5 rounded-full font-semibold transition-all transform hover:scale-105 shadow-lg shadow-amber-500/30">
            Hemen Başvur
          </NuxtLink>
        </div>
    ...
    >
      <div class="pt-24 px-6 pb-12 flex flex-col h-full">
        ...
        <div class="mt-auto pt-8 flex flex-col gap-4">
          ...
          <NuxtLink to="/iletisim" @click="isMobileMenuOpen = false" class="bg-[#f59e0b] text-white text-center py-3 rounded-lg font-bold shadow-lg shadow-amber-500/30">
            Hemen Başvur
          </NuxtLink>
        </div>
      </div>
