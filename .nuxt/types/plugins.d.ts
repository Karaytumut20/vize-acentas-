...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../app/plugins/00.security.client")> &
  InjectionType<typeof import("../../app/plugins/01.bot-detector")> &
  InjectionType<typeof import("../../app/plugins/02.lenis.client")> &
  InjectionType<typeof import("../../app/plugins/03.reveal.client")> &
  InjectionType<typeof import("../../app/plugins/03.reveal.server")> &
  InjectionType<typeof import("../../app/plugins/04.analytics.client")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'nuxt:browser-devtools-timing' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'pinia' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'nuxt-schema-org:defaults' | 'nuxt-schema-org:init' | 'vite-pwa:nuxt:pwa-icons-plugin' | 'nuxt:checkIfLayoutUsed' | 'vite-pwa:nuxt:client:plugin'
  }
}
