...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (isVisible.value) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "pointer-events-none fixed inset-0 z-[99999] px-page-margin" }, _attrs))}><div class="grid h-full w-full mx-auto grid-cols-6 md:grid-cols-12 gap-grid-gutter"><!--[-->`);
        ssrRenderList(12, (i) => {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "app-wrapper tracking-tight min-h-screen bg-theme-bg text-theme-fg selection:bg-theme-fg selection:text-theme-bg transition-colors duration-700 ease-in-out" }, _attrs))}>`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "app-wrapper min-h-screen bg-theme-bg text-theme-fg selection:bg-theme-fg selection:text-theme-bg transition-colors duration-700 ease-in-out" }, _attrs))}><main class="page-wrapper pt-safe-top pb-safe-bottom px-page-margin"><section class="min-h-screen flex flex-col items-center justify-center text-center"><h1${ssrRenderAttrs(mergeProps({ class: "text-8xl md:text-9xl font-light tracking-widest mb-4" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))}>${ssrInterpolate(__props.error?.statusCode || "500")}</h1><p${ssrRenderAttrs(mergeProps({ class: "text-lg md:text-2xl font-light text-gray-400 mb-12" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))}>${ssrInterpolate(is404.value ? "The page you are looking for has vanished." : "An unexpected error occurred.")}</p><button${ssrRenderAttrs(mergeProps({ class: "text-sm md:text-base tracking-widest uppercase border-b border-theme-fg pb-1 hover:text-gray-400 hover:border-gray-400 transition-colors" }, ssrGetDirectiveProps(_ctx, _directive_reveal)))}> Return to Home </button></section></main></div>`);
    };
  }
});
